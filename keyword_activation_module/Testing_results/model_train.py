...
audio = wave.open('2020-11-16/2.wav')
audio.getnframes()
...
df = pd.read_csv('voice_data_testing_2020-11-16.csv')
...
class Data_Generator(tf.keras.utils.Sequence):
    ...
    def getdata(self, music_id_list):
        ...
        for i, m_id in enumerate(music_id_list):
            ...
            audio = wave.open(f'2020-11-16/{m_id}','r')
            frames = []
...
model = M.load_model('../models/6th_version/voice_button_model_lstm_update_2020-11-09.h5')
...
model.save('../models/6th_version/voice_button_model_lstm_update_2020-11-16.h5')
